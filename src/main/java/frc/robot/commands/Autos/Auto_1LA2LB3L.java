...
public class Auto_1LA2LB3L extends SequentialCommandGroup {
  /** Creates a new Auto_1LA2LB3L
   * . */
  ...
  (DriveSubsystem driveSubsystem, ReachSubsystem reachSubsystem, ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem, WristSubsystem wristSubsystem) {
    ...
    addCommands(
      ...
      new ParallelDeadlineGroup(
        ...
        new SetArmPositionExtent(reachSubsystem, armSubsystem, wristSubsystem, 10, -100, () -> false, Constants.k_midNodeWristCUBE, 0, 0, false)
      ),
  ...
  */
  private static final Waypoint[] k_path1 = {
      new Waypoint(3.15, 7.525, Math.toRadians(90)),
  ...
  */
  private static final Waypoint[] k_path4 = {
      ...
      new Waypoint(1.37, 8.563, Math.toRadians(-119.985), 8.581, 6.022)
  };
}
