...
public class Auto_2L_Launch extends SequentialCommandGroup {
  /** Creates a new Auto_2L_Launch. */
  public Auto_2L_Launch(DriveSubsystem driveSubsystem, ArmSubsystem armSubsystem, WristSubsystem wristSubsystem, IntakeSubsystem intakeSubsystem, ReachSubsystem reachSubsystem) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new IntakeCommand(intakeSubsystem, Constants.k_intakePower, true),
      new SetGamePieceCommand(armSubsystem, true),
      new SetWristCommand(wristSubsystem, 0),
      new SetArmCommand(armSubsystem, -75),
      new WaitCommand(1),
      new SetReachCommand(reachSubsystem, 25),
      new WaitCommand(1),
      ...
      new WaitCommand(1),
      new DriveForTimeCommand(driveSubsystem, 4)
    );
  }
}
