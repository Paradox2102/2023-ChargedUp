...
public class Auto_8LD extends ParallelRaceGroup {
  /** Creates a new Auto_8LD. */
  public Auto_8LD(DriveSubsystem driveSubsystem, ReachSubsystem reachSubsystem, ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem) {
