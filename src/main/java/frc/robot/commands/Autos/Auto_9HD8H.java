...
public class Auto_9HD8H extends SequentialCommandGroup {
  /** Creates a new Auto_Briselda. */
  public Auto_9HD8H(ArmSubsystem armSubsystem, ReachSubsystem reachSubsystem, IntakeSubsystem intakeSubsystem, DriveSubsystem driveSubsystem, WristSubsystem wristSubsystem) {
  ...
  private static final Waypoint[] k_path1 = {
      new Waypoint(-11.41, 5.857, Math.toRadians(90)),
...
private static final Waypoint[] k_path2 = {
    new Waypoint(-10.4, 22.5, Math.toRadians(-90)),
    new Waypoint(-9.63, 6, Math.toRadians(-90))
};
}
