...
public class Auto_Briselda3 extends SequentialCommandGroup {
  ...
  public Auto_Briselda3(ArmSubsystem armSubsystem, ReachSubsystem reachSubsystem, IntakeSubsystem intakeSubsystem, DriveSubsystem driveSubsystem, WristSubsystem wristSubsystem) {
    ...
    new SetArmPositionExtent(reachSubsystem, armSubsystem, wristSubsystem, Constants.k_midCubeNodeExtentCUBE, Constants.k_midCubeNodeAngleCUBE, () -> false, Constants.k_midCubeNodeWristCUBE, 0, 0, false),
